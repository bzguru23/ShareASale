 ...
 */
namespace ShareASale\TrackAffiliates\Block\Adminhtml\Affiliate\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    public function __construct(
        ...
        \ShareASale\TrackAffiliates\Helper\Option $optionData,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addType('background', 'ShareASale\TrackAffiliates\Block\Adminhtml\Affiliate\Helper\Background');
